...
url_paths = [
    ...
    "backend/core/domains/questionnaires",
    "backend/core/domains/communications/models",
    "backend/core/domains/events/models",
    "backend/core/domains/clients/models",
    "backend/core/utils/",
    "frontend/admin-crm/src/pages/settings",
    "frontend/admin-crm/src/pages/settings/workflows/",
    "frontend/admin-crm/src/components/workflows/",
    "frontend/admin-crm/src/pages/settings/questionnaires/",
    "frontend/admin-crm/src/components/questionnaires/",
    "frontend/admin-crm/src/hooks/questionnaires/",
    "frontend/admin-crm/src/hooks/workflows/",
